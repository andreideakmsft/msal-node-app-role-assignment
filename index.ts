...
// Define the App Role Assignment object
...
// Call Microsoft Graph to create the App Role Assignment
const resp = await graphClient.api('/servicePrincipals/26444935-9f63-403b-916d-55b67fefa6ab/appRoleAssignedTo').post(appRoleAssignment);
